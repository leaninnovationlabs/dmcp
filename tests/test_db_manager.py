    ...
    def populate_dummy_data(self) -> None:
        ...
        try:
            ...
            users_data = [
                ...
                {"username": "alice_brown", "email": "alice@example.com", "full_name": "Alice Brown"},
                {"username": "charlie_davis", "email": "charlie@example.com", "full_name": "Charlie Davis"},
            ]
            ...
            products_data = [
                ...
                {"name": "Smartphone", "description": "Latest smartphone model", "price": 699.99, "category": "Electronics", "stock_quantity": 100},
                {"name": "T-Shirt", "description": "Cotton t-shirt", "price": 19.99, "category": "Clothing", "stock_quantity": 200},
                {"name": "Jeans", "description": "Comfortable jeans", "price": 49.99, "category": "Clothing", "stock_quantity": 150},
                {"name": "Python Programming Book", "description": "Learn Python programming", "price": 39.99, "category": "Books", "stock_quantity": 75},
                {"name": "Garden Hose", "description": "50ft garden hose", "price": 29.99, "category": "Home & Garden", "stock_quantity": 30},
                {"name": "Basketball", "description": "Official size basketball", "price": 24.99, "category": "Sports", "stock_quantity": 60},
                {"name": "Yoga Mat", "description": "Non-slip yoga mat", "price": 34.99, "category": "Sports", "stock_quantity": 40},
            ]
            ...
            # Create dummy orders
            orders_data = [
                {"user_id": 1, "order_number": "ORD-001", "total_amount": 1019.98, "status": "completed"},
                {"user_id": 2, "order_number": "ORD-002", "total_amount": 69.98, "status": "pending"},
                {"user_id": 3, "order_number": "ORD-003", "total_amount": 149.97, "status": "shipped"},
                {"user_id": 1, "order_number": "ORD-004", "total_amount": 39.99, "status": "completed"},
                {"user_id": 4, "order_number": "ORD-005", "total_amount": 89.98, "status": "pending"},
            ]
            ...
            order_items_data = [
                ...
                {"order_id": 1, "product_id": 3, "quantity": 1, "unit_price": 19.99, "total_price": 19.99},
                {"order_id": 2, "product_id": 2, "quantity": 1, "unit_price": 699.99, "total_price": 699.99},
                {"order_id": 3, "product_id": 4, "quantity": 3, "unit_price": 49.99, "total_price": 149.97},
                {"order_id": 4, "product_id": 5, "quantity": 1, "unit_price": 39.99, "total_price": 39.99},
                {"order_id": 5, "product_id": 6, "quantity": 1, "unit_price": 29.99, "total_price": 29.99},
                {"order_id": 5, "product_id": 7, "quantity": 2, "unit_price": 24.99, "total_price": 49.98},
            ]
