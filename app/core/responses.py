...
def create_success_response(
    data: Any = None, warnings: Optional[List[dict]] = None
) -> StandardAPIResponse:
    """Create a standardized success response."""
    return StandardAPIResponse(
        data=data, success=True, errors=[], warnings=warnings or []
    )
...
def create_error_response(
    ...
    return StandardAPIResponse(
        data=data, success=False, errors=error_list, warnings=warnings or []
    )
...
def create_warning_response(data: Any, warnings: List[str]) -> StandardAPIResponse:
    ...
    return StandardAPIResponse(
        data=data, success=True, errors=[], warnings=warning_list
    )
...
def api_response(
    data: Any = None, success: bool = True, errors: Optional[List[str]] = None
) -> JSONResponse:
